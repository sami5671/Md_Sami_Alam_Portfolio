const ProjectCard = ({ image, title, category }) => {
  return (
    <div className="w-full py-1 flex flex-col justify-center items-center border-b-[1px] lg:px-12">
      <div className="w-full  h-full lg:w-[80%] mb-3 overflow-hidden relative cursor-pointer group">
        <img
